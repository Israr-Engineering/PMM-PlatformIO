...
class PmmRS485Class : public Stream {
  public:
#ifdef __MBED__
    PmmRS485Class(HardwareSerial& hwSerial, PinName txPin, PinName dePin, PinName rePin);
#endif
    PmmRS485Class(HardwareSerial& hwSerial, int txPin, int dePin, int rePin);
