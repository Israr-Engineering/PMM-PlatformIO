...
void ViewSettingsPage(PmmEthernetClient client)
{
    ...
    client.println("<div class='Group_Item'> <div class='Group_Item_lbl'> <label for='MacAddress'>Mac Address</label> </div><div class='Group_Item_input'> <label for='MacAddress' style='left: 24%;top: 40%;'>48:7E</label> <input type='text' class='input' id='MacAddress' name='MacAddress' value='72:64:64:32' style='width: 122px; margin-left: 22px;'> </div></div>");
