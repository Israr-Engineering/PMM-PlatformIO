...
void ViewSettingsPage(PmmEthernetClient client)
{
    ...
    client.println("function ReadFromController2(){let e=new XMLHttpRequest,t=window.location.href+'/api?message=111,000,000';e.open('GET',t,!0),e.onreadystatechange=function(){if(4===e.readyState&&200===e.status){let t=e.responseText;SetDataToFild(t)}},e.send()}");
