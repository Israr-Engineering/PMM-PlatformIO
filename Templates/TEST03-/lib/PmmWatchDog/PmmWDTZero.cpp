...
PmmWDTZero::PmmWDTZero()
{
}

void PmmWDTZero::setup(unsigned int wdtzerosetup)
{
...
void PmmWDTZero::attachShutdown(voidFuncPtr callback)
{
  WDT_Shutdown = callback;
}

void PmmWDTZero::detachShutdown()
{
  WDT_Shutdown = NULL;
}