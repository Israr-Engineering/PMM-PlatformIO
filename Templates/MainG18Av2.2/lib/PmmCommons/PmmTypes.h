...
typedef struct PMMGeneral
{
    ...
    bit Ext01Pac9535 = false; // true if extesion board support Pac9535 chip
    ...
    int Ext01Name = 622; //(19) 00 => zero = No extesion board
    // int Ext01Address = 0;//(20)
    u_int8_t Ext01Address01 = 0;
    u_int8_t Ext01Address02 = 0;
    int Ext02Name = 622; //(21)
    // int Ext01Address = 0;//(22)
    u_int8_t Ext02Address01 = 0;
    u_int8_t Ext02Address02 = 0;
    int Ext03Name = 622; //(23)
...
typedef struct PMMProtocol
{
    ...
    int QuantityCoilsStatus = 120;             // (06)
    int QuantityInputStatus = 120;             // (07)

    int QuantityHoldingRegisters = 120; // (08)
    int QuantityInputRegisters = 120;   // (09)
...
typedef struct PMMSERIAL
{
    ...
    long SerialConfig = 8; //(4)(5)  : 23 u_int16_t config = (databitLong | parityLong | stopbitLong);Arduino Stanard
...
typedef struct Product
{
    ...
    PMMSERIAL PmmSerial[6]; // PmmSerial[0] is the ethernet port
    PMMTimer PmmTimers;
