...
bool BlockAutoWest = false;
bool BlockAutoEast = false;

void RunAutoMode()
{
// STEP00 : Check Auto modes
#ifdef TESTMODEONLY
    Pmmm1103.AUTOLOCALMODE = (Pmmm1103.LOCALREMOTETimer > 10) ? true : false;
#else
...
#ifdef TESTMODEONLY
    if (Pmmm1103.RTCSeconds % 10 == 0) // For test only
#else
    ...
    // Update registers
    // if (Pmmm1103.RemoteTargetAngle != Pmmm1103.CalcTargetAngle) ;
    // ModbusRTU01Server.PmmModBusRTUServerHoldingWrite(24, Pmmm1103.CalcTargetAngle);
    ReadActualAngle();
    ...
    if ((Pmmm1103.CalcTargetAngle > Pmmm1103.MPUCalAngle) && (AutoMoveEnable) && (!BlockAutoWest)) // move to west +++
    {
        Pmmm1103.MoveEast = true;
        Pmmm1103.MoveWest = false;
    ...
    else if ((Pmmm1103.CalcTargetAngle < Pmmm1103.MPUCalAngle) && (AutoMoveEnable) && (!BlockAutoEast)) // move to east ---
    {
        Pmmm1103.MoveEast = false;
        Pmmm1103.MoveWest = true;
