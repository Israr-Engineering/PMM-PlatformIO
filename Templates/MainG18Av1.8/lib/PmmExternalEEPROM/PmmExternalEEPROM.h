...
#ifndef _PMM_EXTERNAL_EEPROM_H
#define _PMM_EXTERNAL_EEPROM_H
...
private:
  ...
  // for PMM the defualte is Microchip 24LC256-I/SN 256Kbit
  struct_memorySettings settings = {
      ...
      .memorySize_bytes = (uint32_t)256 * 1024 / 8,	// equals 32 KB
      .pageSize_bytes = 64,
      .pageWriteTime_ms = 5,
