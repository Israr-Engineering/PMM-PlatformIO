...
void ThisDeviceSetup()
{
      ...
      if (!ReadyToUse) 
      {
        ...
        // AO Pins
        PMM_AO_Pins[0] = A1;
        PMM_AO_Pins[1] = A1;PMM_AO_Pins[2] = A2;PMM_AO_Pins[3] = A3;PMM_AO_Pins[4] = A4;PMM_AO_Pins[5] = A5;PMM_AO_Pins[6] = A6;
        PMM_AO_Pins[7] = A7;PMM_AO_Pins[8] = A8;PMM_AO_Pins[9] = A9;PMM_AO_Pins[10] = A10;PMM_AO_Pins[11] = A11;PMM_AO_Pins[12] = A12;
        PMM_AO_Pins[13] = A13;PMM_AO_Pins[14] = A14;PMM_AO_Pins[15] = A15;PMM_AO_Pins[16] = A16;PMM_AO_Pins[17] = A1;PMM_AO_Pins[18] = A2;
        PMM_AO_Pins[19] = A3;PMM_AO_Pins[20] = A4;PMM_AO_Pins[21] = A5;PMM_AO_Pins[22] = A6;PMM_AO_Pins[23] = A7;PMM_AO_Pins[24] = A8;
        //PMM_AO_Pins[25] = A9;      
        // LEDs Pins
        ...
        // Setup PWM
        for (uint8_t i = 0; i < 25; i++) pinMode(PMM_AO_Pins[i], OUTPUT);
