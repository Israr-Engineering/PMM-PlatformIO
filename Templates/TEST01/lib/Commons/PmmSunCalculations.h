...
array<string, 18> SunCalculations(time_t date, double lat, double lang, int TimeZone = 3, double TrackerWidth = 4, double Post2Post = 11)
{
    ...
    array<string, 18> arr;
    Resulte = "Time : " + PMMDatetimeNowStr(date) + " (Lang,Lat) = " + to_string(lang) + " , " + to_string(lat) + "; \n";
...
#pragma region Sunrise and Sunset
    ...
    Resulte = Resulte + "Sunrise = " + DateTimeToString((year(Sunrise)), month(Sunrise), day(Sunrise), hour(Sunrise), minute(Sunrise), second(Sunrise)) + "\n";
    arr[11] = DateTimeToString((year(Sunrise)-1970), month(Sunrise), day(Sunrise), hour(Sunrise), minute(Sunrise), second(Sunrise));

    Resulte = Resulte + "Sunrise = " + DateTimeToString((year(Sunset)), month(Sunset), day(Sunset), hour(Sunset), minute(Sunset), second(Sunset)) + "\n";
    arr[12] = DateTimeToString((year(Sunset)-1970), month(Sunset), day(Sunset), hour(Sunset), minute(Sunset), second(Sunset));
