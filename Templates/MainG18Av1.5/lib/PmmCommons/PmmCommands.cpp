...
void PmmWriteGeneralSettings(string Message, int RomTarget)
{
    ...
    ThisProduct.PmmGeneral.SerialNumber = stol(values[1]);
    ThisProduct.PmmGeneral.FirstTimeRun = stoi(values[2]);
    ThisProduct.PmmGeneral.LifeTime = stol(values[3]);
    ThisProduct.PmmGeneral.NumberOfCycles = stol(values[4]);
    ThisProduct.PmmGeneral.LastRunningTime = stol(values[5]);
    ThisProduct.PmmGeneral.NumberOfRunningTimes = stol(values[6]);
    ...
    ThisProduct.PmmGeneral.Ext01Address01 = lowByte(stoi(values[10]));
    ThisProduct.PmmGeneral.Ext01Address02 = highByte(stoi(values[10]));
    ThisProduct.PmmGeneral.Ext02Name = stoi(values[14]);//(19) 00 => zero = No extesion board
    ThisProduct.PmmGeneral.Ext02Address01 = lowByte(stoi(values[10]));
    ThisProduct.PmmGeneral.Ext02Address02 = highByte(stoi(values[10]));
    ThisProduct.PmmGeneral.Ext03Name = stoi(values[15]);//(19) 00 => zero = No extesion board
    ThisProduct.PmmGeneral.Ext03Address01 = lowByte(stoi(values[10]));
    ThisProduct.PmmGeneral.Ext03Address02 = highByte(stoi(values[10]));
   
    ThisProduct.PmmGeneral.I2CServerAddress = stoi(values[20]);
    ThisProduct.PmmGeneral.Spare26 = stoi(values[20]);
    ThisProduct.PmmGeneral.Spare27 = stoi(values[20]);
    ThisProduct.PmmGeneral.Spare28 = stoi(values[20]);
    ThisProduct.PmmGeneral.Spare29 = stoi(values[20]);
    ThisProduct.PmmGeneral.Spare30 = stoi(values[20]);
