...
String PMMCommnads(string readData)
{
   ...
   case 900 :  result =  result = PMMIsAlive(); break;
   case 948 :  NVIC_SystemReset(); break;
   case 910 :  result = SetInternalRTC(readData); break;
   case 911 :  result = GetInternalRTC(); break;
   case 920 :  result = SetExternalRTC(readData); break;
   case 921 :  result = GetExternalRTC(); break;
