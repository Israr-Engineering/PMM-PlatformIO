...
class PmmSPIClassSAMD : public arduino::HardwareSPI {
  public:
  PmmSPIClassSAMD(SERCOM *p_sercom, uint8_t uc_pinMISO, uint8_t uc_pinSCK, uint8_t uc_pinMOSI, SercomSpiTXPad, SercomRXPad);
...
//#define SPIClass PmmSPIClassSAMD

#if SPI_INTERFACES_COUNT > 0
  extern PmmSPIClassSAMD SPI;
#endif
#if SPI_INTERFACES_COUNT > 1
  extern PmmSPIClassSAMD SPI1;
#endif
#if SPI_INTERFACES_COUNT > 2
  extern PmmSPIClassSAMD SPI2;
#endif
#if SPI_INTERFACES_COUNT > 3
  extern PmmSPIClassSAMD SPI3;
#endif
#if SPI_INTERFACES_COUNT > 4
  extern PmmSPIClassSAMD SPI4;
#endif
#if SPI_INTERFACES_COUNT > 5
  extern PmmSPIClassSAMD SPI5;
#endif
