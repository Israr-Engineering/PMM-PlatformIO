...
uint8_t  PmmW5100Class::chip = 0;
uint8_t  PmmW5100Class::CH_BASE_MSB;
uint8_t  PmmW5100Class::ss_pin = SS_PIN_DEFAULT;
#ifdef ETHERNET_LARGE_BUFFERS
uint16_t PmmW5100Class::SSIZE = 2048;
uint16_t PmmW5100Class::SMASK = 0x07FF;
#endif
PmmW5100Class W5100;

// pointers and bitmasks for optimized SS pin
#if defined(__AVR__)
  volatile uint8_t * PmmW5100Class::ss_pin_reg;
  uint8_t PmmW5100Class::ss_pin_mask;
  ...
  volatile uint32_t * PmmW5100Class::ss_pin_reg;
  uint32_t PmmW5100Class::ss_pin_mask;
...
uint8_t PmmW5100Class::init(void)
{
...
uint8_t PmmW5100Class::softReset(void)
{
	uint16_t count=0;
...
uint8_t PmmW5100Class::isW5100(void)
{
	chip = 51;
...
uint8_t PmmW5100Class::isW5200(void)
{
	chip = 52;
...
uint8_t PmmW5100Class::isW5500(void)
{
	chip = 55;
...
W5100Linkstatus PmmW5100Class::getLinkStatus()
{
	uint8_t phystatus;
...
uint16_t PmmW5100Class::write(uint16_t addr, const uint8_t *buf, uint16_t len)
{
	uint8_t cmd[8];
...
uint16_t PmmW5100Class::read(uint16_t addr, uint8_t *buf, uint16_t len)
{
	uint8_t cmd[4];
...
void PmmW5100Class::execCmdSn(SOCKET s, SockCMD _cmd)
{
