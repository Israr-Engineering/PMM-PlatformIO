...
void PmmInitializeProjectSettings()
{
    ...
    // ThisProduct.PmmSerial[1].PortDataBit = 8;
    // ThisProduct.PmmSerial[1].PortParity = 0;
    // ThisProduct.PmmSerial[1].PortStopBit = 1;
    // ThisProduct.PmmSerial[1].BaudRate,
    // ThisProduct.PmmSerial[1].TXPin,
    // ThisProduct.PmmSerial[1].RXPin,
    // ThisProduct.PmmSerial[1].SerialSelectionPin,
    // ThisProduct.PmmSerial[1].SerialPort;
