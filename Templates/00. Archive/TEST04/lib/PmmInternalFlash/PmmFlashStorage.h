...
class PmmFlashClass {
public:
  PmmFlashClass(const void *flash_addr = NULL, uint32_t size = 0);
...
template<class T>
class PmmFlashStorageClass {
public:
  PmmFlashStorageClass(const void *flash_addr) : flash(flash_addr, sizeof(T)) { };
