...
void PmmWriteGeneralSettings(string Message, int RomTarget)
{
    ...
    ThisProduct.PmmGeneral.SettingsRef = stoi(values[20]);

    ThisProduct.PmmGeneral.Spare26 = 0;
    ThisProduct.PmmGeneral.Spare27 = 0;
    ThisProduct.PmmGeneral.Spare28 = 0;
    ThisProduct.PmmGeneral.Spare29 = 0;
    ThisProduct.PmmGeneral.Spare30 = 0;
...
void PmmWriteSerialSettings(string Message, int Portnumber, int RomTarget)
{
    ...
    {
        if (Portnumber == 0)
            Serial_flash_store00.write(ThisProduct.PmmSerial[Portnumber]); // Ethernet Port
        if (Portnumber == 1)
            Serial_flash_store01.write(ThisProduct.PmmSerial[Portnumber]); // Serial
        if (Portnumber == 2)
            Serial_flash_store02.write(ThisProduct.PmmSerial[Portnumber]); // Serial
        if (Portnumber == 3)
            Serial_flash_store03.write(ThisProduct.PmmSerial[Portnumber]); // Serial
        if (Portnumber == 4)
            Serial_flash_store04.write(ThisProduct.PmmSerial[Portnumber]); // Serial
    }
    else if (RomTarget == 1) // EEprom
    {
    }
...
String PmmReadSerialSettings(int Portnumber, int RomTarget)
{
    ...
    {
        if (Portnumber == 0)
            ThisProduct.PmmSerial[Portnumber].PmmProtocols = Serial_Protoco_store00.read(); // Ethernet Port
        if (Portnumber == 1)
            ThisProduct.PmmSerial[Portnumber].PmmProtocols = Serial_Protoco_store01.read(); // Serial
        if (Portnumber == 2)
...
void PmmWriteProtocol(string Message, int Portnumber, int RomTarget)
{
    ...
    {
        if (Portnumber == 0)
            Serial_Protoco_store01.write(ThisProduct.PmmSerial[Portnumber].PmmProtocols); // Ethernet Port
        if (Portnumber == 1)
            Serial_Protoco_store02.write(ThisProduct.PmmSerial[Portnumber].PmmProtocols); // Serial
        if (Portnumber == 2)
            Serial_Protoco_store03.write(ThisProduct.PmmSerial[Portnumber].PmmProtocols); // Serial
        if (Portnumber == 3)
            Serial_Protoco_store04.write(ThisProduct.PmmSerial[Portnumber].PmmProtocols); // Serial
        if (Portnumber == 4)
            Serial_Protoco_store04.write(ThisProduct.PmmSerial[Portnumber].PmmProtocols); // Serial
    }
    else if (RomTarget == 1) // EEprom
...
void PmmWriteDeviceCalibration(string Message, int PageNumber, int RomTarget)
{
    ...
    {
        if (PageNumber == 0)
            Claibration_flash_Page01.write(ThisProduct.PmmCalibrationPage[PageNumber]);
        if (PageNumber == 1)
            Claibration_flash_Page02.write(ThisProduct.PmmCalibrationPage[PageNumber]);
        if (PageNumber == 2)
            Claibration_flash_Page03.write(ThisProduct.PmmCalibrationPage[PageNumber]);
        if (PageNumber == 3)
            Claibration_flash_Page04.write(ThisProduct.PmmCalibrationPage[PageNumber]);
    }
    else if (RomTarget == 1) // EEprom
    {
    }
...
String PmmReadDeviceCalibration(int PageNumber, int RomTarget)
{
    ...
    {
        if (PageNumber == 0)
            ThisProduct.PmmCalibrationPage[PageNumber] = Claibration_flash_Page01.read();
        if (PageNumber == 1)
            ThisProduct.PmmCalibrationPage[PageNumber] = Claibration_flash_Page02.read();
        if (PageNumber == 2)
            ThisProduct.PmmCalibrationPage[PageNumber] = Claibration_flash_Page03.read();
        if (PageNumber == 3)
            ThisProduct.PmmCalibrationPage[PageNumber] = Claibration_flash_Page04.read();
    }
    else if (RomTarget == 1) // EEprom
    {
    }
...
String PMMCommnads(string readData)
{
    ...
    if (readData.length() > 9)
    {
        ...
        {
        case 100:
            PmmWriteGeneralSettings(readData, RomSelect);
            break;
        case 101:
        ...
        case 102:
            PmmWriteTimerSettings(readData, RomSelect);
            break;
        case 103:
        ...
        case 110:
            PmmWriteSerialSettings(readData, 0, RomSelect);
            break; // Ethernet port
        case 111:
        ...
        case 112:
            PmmWriteSerialSettings(readData, 1, RomSelect);
            break;
        case 113:
        ...
        case 114:
            PmmWriteSerialSettings(readData, 2, RomSelect);
            break;
        case 115:
        ...
        case 116:
            PmmWriteSerialSettings(readData, 3, RomSelect);
            break;
        case 117:
        ...
        case 130:
            PmmWriteProtocol(readData, 0, RomSelect);
            break;
        case 131:
        ...
        case 132:
            PmmWriteProtocol(readData, 1, RomSelect);
            break;
        case 133:
        ...
        case 134:
            PmmWriteProtocol(readData, 2, RomSelect);
            break;
        case 135:
        ...
        case 136:
            PmmWriteProtocol(readData, 3, RomSelect);
            break;
        case 137:
        ...
        case 138:
            PmmWriteProtocol(readData, 4, RomSelect);
            break;
        case 139:
