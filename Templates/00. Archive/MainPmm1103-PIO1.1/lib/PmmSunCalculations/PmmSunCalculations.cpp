...
#//pragma region Equation of Time
    ...
    HRA = (double)((hour(tmpLSTh) * 60) + minute(LST) + ((double)(second(LST)) / 60)) * (double)15 / 60;
...
float PmmSunCalculations::PmmMPUReadRawAngle(float MinAngle, float MaxAngle, float MinCalAngle, float MaxCalAngle) // This Function Get MPU Angle With Calibration *** This Function Uesd in All of The Code
{
