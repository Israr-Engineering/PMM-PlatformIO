...
typedef struct PMMSERIAL
{
    ...
    // u_int32_t Port = 0; //
    u_int16_t Port01 = 502; //(37)(38)
    u_int16_t Port02 = 503; //(39)
    u_int16_t Port03 = 504; //(40)
    u_int16_t  Port04 = 505; //(41)

    int PortID = 0; //(42)
    int UDPPacketSize = 0; //(43)
    int RemoteIP = 0; //(44)

    //(45)
    bit Enabled = false;
    bit EnableSerial = false;
    bit SerialServer = false;
    bit PeerToPeer = false;
    bit spare3104 = false;
    bit spare3105 = false;
    bit spare3106 = false;
    bit spare3107 = false;
