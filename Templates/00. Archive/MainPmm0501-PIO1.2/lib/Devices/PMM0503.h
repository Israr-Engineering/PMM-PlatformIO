...
static const uint8_t DOETHERRST = 16ul;        // PA14
static const uint8_t DOETHERINT = 14ul;        // PA15
static const uint8_t DOTERMRESISTOR = 12ul;    // PB02
static const uint8_t DORS485SELECT = 13ul;     // PB03
static const uint8_t DOHALFDUBLIX = 22ul;      // PA02
