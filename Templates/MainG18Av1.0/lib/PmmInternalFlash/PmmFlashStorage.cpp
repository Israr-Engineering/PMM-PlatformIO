...
PmmFlashClass::PmmFlashClass(const void *flash_addr, uint32_t size) :
...
void PmmFlashClass::write(const volatile void *flash_ptr, const void *data, uint32_t size)
{
...
void PmmFlashClass::erase(const volatile void *flash_ptr, uint32_t size)
{
...
void PmmFlashClass::erase(const volatile void *flash_ptr)
{
#if defined(__SAMD51__)
...
void PmmFlashClass::read(const volatile void *flash_ptr, void *data, uint32_t size)
{
