...
// STEP03 : Update system IO images every cycle
  ...
  if ((millis() - MainLoopTimer) > 1000)
  {
    ...
    if (DIDEBUGMODE_Status)
    {
      ...
      SerialUSB.print("/ Input[2] : ");
      SerialUSB.print(int_input[2]);
      SerialUSB.print("/ Output[2] : ");
      ...
      SerialUSB.print("/ ClientAvaliable : ");
      SerialUSB.println(ClientAvaliable); // int ClientAvaliable = 0 ;
    }
