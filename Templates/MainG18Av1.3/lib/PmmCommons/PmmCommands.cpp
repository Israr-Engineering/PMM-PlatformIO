...
String PmmReadSerialSettings( int Portnumber, int RomTarget)
{
    ...
    if (RomTarget == 0)
   {
    ...
    settings = String(settings + String(tmpInt));
...
void PmmWriteProtocol(string Message, int Portnumber, int RomTarget)
{
    ...
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsModBus =binaryInt[15];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsCanBus =binaryInt[14];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsProfiBus =binaryInt[13];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsProfiNet =binaryInt[12];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsBACnet =binaryInt[11];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsDLMS =binaryInt[10];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsMBus =binaryInt[9];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsOPC =binaryInt[8];
    
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare08 =binaryInt[7];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare09 =binaryInt[6];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare10 =binaryInt[5];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare11 =binaryInt[4];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare12 =binaryInt[3];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare13 =binaryInt[2];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare14 =binaryInt[1];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsRunning =binaryInt[0];
    
    // ModBus Settings
    // int Spare00 ; (01)
    IntToBits(stoi(values[1]));
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.ModBusRTU =binaryInt[15];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.ModBusTCP =binaryInt[14];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.ModBusSlave =binaryInt[13];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.ModBusMaster =binaryInt[12];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.ReadCoilsStatus =binaryInt[11];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.ReadInputStatus =binaryInt[10];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.ReadHoldingRegisters =binaryInt[9];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.ReadInputRegisters =binaryInt[8];
    
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.WriteSingleCoil =binaryInt[7];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.WriteSingleRegister =binaryInt[6];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.WriteMultipleCoils =binaryInt[5];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.WriteMultipleRegisters =binaryInt[4];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.CoilsStatus =binaryInt[3];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.InputStatus =binaryInt[2];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.HoldingRegisters =binaryInt[1];
    ThisProduct.PmmSerial[Portnumber].PmmProtocols.InputRegisters =binaryInt[0];
...
String PmmReadProtocol( int Portnumber, int RomTarget)
{
    ...
    if (RomTarget == 0)
   {
    ...
    //Build String
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsModBus));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsCanBus ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsProfiBus ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsProfiNet ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsBACnet ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsDLMS ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsMBus ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsOPC ));
    
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare08 ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare09 ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare10 ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare11 ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare12 ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare13 ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.Spare14 ));
    settings = String(settings + String(ThisProduct.PmmSerial[Portnumber].PmmProtocols.IsRunning ));
    settings = String(settings + ",");
    // ModBus Settings
    // int Spare00 ; (01)
