...
PmmRTCZero::PmmRTCZero()
{
  _configured = false;
}

void PmmRTCZero::begin(bool resetTime)
{
  uint16_t tmp_reg = 0;
...
void PmmRTCZero::enableAlarm(Alarm_Match match)
{
  if (_configured) {
...
void PmmRTCZero::attachInterrupt(voidFuncPtr callback)
{
  RTC_callBack = callback;
}

void PmmRTCZero::detachInterrupt()
{
  RTC_callBack = NULL;
}

void PmmRTCZero::standbyMode()
{
...
void PmmRTCZero::setSeconds(uint8_t seconds)
{
  if (_configured) {
...
void PmmRTCZero::setMinutes(uint8_t minutes)
{
  if (_configured) {
...
void PmmRTCZero::setHours(uint8_t hours)
{
  if (_configured) {
...
void PmmRTCZero::setTime(uint8_t hours, uint8_t minutes, uint8_t seconds)
{
  if (_configured) {
    setSeconds(seconds);
    setMinutes(minutes);
...
void PmmRTCZero::setDay(uint8_t day)
{
  if (_configured) {
...
void PmmRTCZero::setMonth(uint8_t month)
{
  if (_configured) {
...
void PmmRTCZero::setYear(uint8_t year)
{
  if (_configured) {
...
void PmmRTCZero::setDate(uint8_t day, uint8_t month, uint8_t year)
{
  if (_configured) {
    setDay(day);
    setMonth(month);
...
void PmmRTCZero::setAlarmSeconds(uint8_t seconds)
{
  if (_configured) {
...
void PmmRTCZero::setAlarmMinutes(uint8_t minutes)
{
  if (_configured) {
...
void PmmRTCZero::setAlarmHours(uint8_t hours)
{
  if (_configured) {
...
void PmmRTCZero::setAlarmTime(uint8_t hours, uint8_t minutes, uint8_t seconds)
{
  if (_configured) {
...
void PmmRTCZero::setAlarmDay(uint8_t day)
{
  if (_configured) {
...
void PmmRTCZero::setAlarmMonth(uint8_t month)
{
  if (_configured) {
...
void PmmRTCZero::setAlarmYear(uint8_t year)
{
  if (_configured) {
...
void PmmRTCZero::setAlarmDate(uint8_t day, uint8_t month, uint8_t year)
{
  if (_configured) {
    setAlarmDay(day);
    setAlarmMonth(month);
...
uint32_t PmmRTCZero::getY2kEpoch()
{
  return (getEpoch() - EPOCH_TIME_OFF);
}

void PmmRTCZero::setAlarmEpoch(uint32_t ts)
{
  if (_configured) {
...
void PmmRTCZero::setEpoch(uint32_t ts)
{
  if (_configured) {
    if (ts < EPOCH_TIME_OFF) {
      ts = EPOCH_TIME_OFF;
...
void PmmRTCZero::setY2kEpoch(uint32_t ts)
{
  if (_configured) {
...
void PmmRTCZero::configureClock() {
...
inline void PmmRTCZero::RTCreadRequest() {
  if (_configured) {
...
inline bool PmmRTCZero::RTCisSyncing()
{
  return (RTC->MODE2.STATUS.bit.SYNCBUSY);
}

void PmmRTCZero::RTCdisable()
{
...
void PmmRTCZero::RTCresetRemove()
{
