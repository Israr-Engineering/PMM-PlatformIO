...
#define PMM_D1_ETH_INT      (31u) //PA27 : Digital Input : Ethernet controller interrupt 
#define PMM_DO_RDENA        (3u) //PB09 : Digital output : RS485 Direction control  
#define PMM_DI_LossOfPower  (4u) //PA04 : Digital Input :loos of power 
#define PMM_DO_FLASH_CS     (15u) //PB02 : Digital output : Flash chip select command 
#define PMM_DO_FLASH_EN     (5u) //PA05 : Digital output : Flash chip select command 
#define PMM_IRQ_ISO         (10u) //PA06
#define PMM_SCSN_WIZ        (11u) //PA07
#define PMM_3_4_wire_con    (22u) //PA16
#define PMM_GP1             (1u) //PA10
#define PMM_GP2             (0u) //PA11
#define PMM_3_4_wire_ORD    (24u) //PA17
#define PMM_ISO_SCSN        (21u) //PA18
