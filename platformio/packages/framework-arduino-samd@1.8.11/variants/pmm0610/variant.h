...
#define PMM_CTS             (4u) //PA04
#define PMM_DI_LossOfPower  (5u) //PA05 : Digital Input :loos of power 
...
#define PMM_DO_RDENA        (7u) //PA09 : Digital output : RS485 Direction control  
#define PMM_NRST            (18u) //PA14
#define PMM_BUSY            (19u) //PA15
#define PMM_Lora_CS         (13u) //PA20
#define PMM_LoraRST         (14u) //PA21
#define PMM_DO_FLASH_CS     (8u) //PA10 : Digital output : Flash chip select command 
#define PMM_DO_FLASH_EN     (9u) //PA11 : Digital output : Flash chip select command 
