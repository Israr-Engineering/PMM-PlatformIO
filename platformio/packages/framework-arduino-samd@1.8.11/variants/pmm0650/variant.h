...
//03b. Flash memory
#define PMM_DO_FLASH_CS    (2u) //PB08 : Digital output : Flash chip select command 
...
#define PMM_D1_ETH_INT     (25u)  //PA02 : Digital Input : Ethernet controller interrupt 
#define PMM_DI_LossOfPower (32u) //PA28 : Digital Input :loos of power 
...
#define PMM_DI_PROG        (14u) //PA21 : Digital Input - general (front panel dip switch)
#define PMM_DI_PROG01      (7u) //PA09 : Digital Input - general (front panel dip switch )
...
#define PMM_RUN            (0u) //PA11
#define PMM_DATA           (1u) //PA10
#define PMM_DO_RDENA       (6u) //PA08 : Digital output : RS485 Direction control  
